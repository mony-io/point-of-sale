    ...
    <div className="flex-1 h-screen">
      ...
      <div className="grid grid-cols-4 gap-4 w-full">
        ...
        <div className="col-span-2 cursor-pointer">
          <Link to="/sale">
            <div className="bg-slate-100 h-12 flex justify-start items-center m-2 rounded-sm hover:bg-blue-400">
              <div className="border-gray-400 border-r-2 pr-3">
                <HiShoppingCart size={24} className="ml-4 text-slate-500" />
              </div>
              <span className="text-slate-500 text-sm ml-8">ការលក់</span>
            </div>
          </Link>
        </div>
        ...
        <div className="col-span-4 bg-white h-[460px] m-2 mb-4">
