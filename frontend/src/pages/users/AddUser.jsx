        ...
        <div className="grid grid-cols-4 gap-4 mt-7">
          <div className="col-span-2 px-9">
            <div className="mb-6">
              ...
              />
              {userMsg && <span className="text-red-500 text-sm">{userMsg}</span>}
            </div>
            <div className="mb-6">
              <label
                htmlFor="password"
            ...
            <div className="mb-6">
              ...
              >
                ...
                {data && data.map((item, index) => {
                  return (
                    <option value={item.role_id} key={index + 1}>{item.role_name}</option>
                  )
                })}
              </select>
              {roleMsg && <span className="text-red-500 text-sm">{roleMsg}</span>}
