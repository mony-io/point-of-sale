            ...
            <tbody>
                  ...
                  >
                    ...
                    <td className="p-3 whitespace-nowrap">
                      ...
                      {user.username !== auth.username ? <>
                        <button className="mx-2 px-3 py-1.5 rounded font-medium tracking-wider text-blue-700 bg-blue-200 hover:shadow" onClick={async () => {
                        ...
                        <button className="px-3 py-1.5 mr-2 rounded font-medium tracking-wider text-blue-300 bg-gray-100" disabled onClick={() => { setId("") }}>
                          <BsPencilSquare size={20} />
                        </button>
                        <button className="px-3 py-1.5 mr-2 rounded font-medium tracking-wider text-red-300 bg-gray-100" disabled onClick={() => { setId("") }}>
                          <AiTwotoneDelete size={20} />
                        </button>
                        <button className="px-3 py-1.5 rounded font-medium tracking-wider text-gray-300 bg-gray-100" disabled onClick={() => { setId("") }}>
                          <RiLockPasswordFill size={20} />
                        </button>
                      </>}
              ...
              <Modal title="លុបអ្នកប្រើប្រាស់" className="modal-fonts" open={open} onCancel={onClose} footer={[
                ...
                <Button
                  ...
                  loading={loading}
                  type="button"
                  className="bg-blue-600 text-white text-md leading-tight rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out ml-1" onClick={deleteMutaion.mutate}
                >
                  យល់ព្រម
                </Button>
              ]}>
              ...
              {/* update user modal */}
              <Modal title="កែប្រែអ្នកប្រើប្រាស់" width={900} className="modal-fonts" open={updateModal} onCancel={onClose} footer={[
                <Button
                  key="cancel"
                  type="button"
                  className="bg-red-500 text-white leading-tight rounded shadow-md hover:bg-red-600 hover:shadow-lg focus:bg-red-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-700 active:shadow-lg transition duration-150 ease-in-out ml-1 text-md" onClick={onClose}
                ...
                <Button
                  ...
                  loading={loading}
                  type="button"
                  className="bg-blue-600 text-white text-md leading-tight rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out ml-1" onClick={updateMutation.mutate}
                >
                  កែប្រែ
                </Button>
              ]}>
